      ...
      <div class="card-body">
        <form action="{{url('/page1')}}" method="POST" onsubmit="assignValues()">
                ...
                <div class="col-md-6 mt-2">
                  <div class="form-group">
                    ...
                    <select class="form-control form-select" name="donationType" id="donationType" required onchange="updatePurposeOptions()">
                      ...
                      <option value="Parents teachers Association">Parents teachers Association</option>
                    </select>
                  </div>
                </div>
          ...
          <div class="text-center">
            <button class="mt-2 btn btn-lg text-light" type="submit" style="background-color: #431F50;">PROCEED</button>
          </div>
        </form>
      </div>
    </div>
...
<script>
  function assignValues() {
    ...
    document.getElementById('donorName') = donorName.concat(" ", donorName1);
  }
